...
const styles = {
  container: { textAlign: "center", paddingTop: "4rem", color: "white", minHeight: "100vh", backgroundImage: "url('/45.avif')", backgroundSize: "cover", backgroundPosition: "center", backgroundAttachment: "fixed" },
