...
const styles = {
  container: { textAlign: "center", paddingTop: "4rem", color: "white", minHeight: "100vh", backgroundImage: "url('/wow.jpg')", backgroundSize: "cover", backgroundPosition: "center top", backgroundAttachment: "fixed" },
